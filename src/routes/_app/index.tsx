            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2.5">
                {statsQ.data.porDiretoria.map((d) => {
                  const pct =
                    statsQ.data.totalMembros > 0 ? (d.total / statsQ.data.totalMembros) * 100 : 0
                  return (
                    <div key={d.diretoria} className="flex flex-col gap-1">
  ...
  return (
    <div>
      <header className="mb-6">
        <p className="text-muted-foreground text-sm font-medium first-letter:capitalize">{hoje}</p>
